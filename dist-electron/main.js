...
import require$$1$5, { dialog, app, BrowserWindow, ipcMain, Menu } from "electron";
...
Object.defineProperty(AppUpdater$2, "__esModule", { value: true });
AppUpdater$2.NoOpLogger = AppUpdater$2.AppUpdater = void 0;
...
AppUpdater$2.AppUpdater = AppUpdater$1;
...
AppUpdater$2.NoOpLogger = NoOpLogger;
...
const AppUpdater_1$1 = AppUpdater$2;
...
const AppUpdater_1 = AppUpdater$2;
...
(function(exports) {
  ...
  var AppUpdater_12 = AppUpdater$2;
...
class AppUpdater2 {
  ...
  setupEventHandlers() {
    ...
    main$2.autoUpdater.on("error", (err) => {
      ...
      if (err.message.includes("404") || err.message.includes("401") || err.message.includes("403") || err.message.includes("unauthorized") || err.message.includes("authentication")) {
        log.info("Network/auth error - this is normal in some cases");
        this.sendUpdateStatus("not-available");
        return;
      }
      this.sendUpdateStatus("error", void 0, "Unable to check for updates");
    });
    main$2.autoUpdater.on("download-progress", (progressObj) => {
      const progress = Math.round(progressObj.percent);
      log.info(`Download progress: ${progress}%`);
      this.sendUpdateStatus("downloading", void 0, void 0, progress);
    });
  ...
  sendUpdateStatus(status, version, error2, progress) {
...
function createWindow() {
  ...
  win.maximize();
  appUpdater = new AppUpdater2(win);
      ...
      return new Promise((resolve, reject) => {
        ...
        ipcMain.once("invoice-rendered", async () => {
          ...
          try {
            ...
            fs$j.writeFileSync(filePath, pdf);
            ...
            console.error("Failed to generate PDF:", error2);
            dialog.showErrorBox(
  ...
  ipcMain.handle("check-for-updates", () => {
    appUpdater == null ? void 0 : appUpdater.checkForUpdates();
  });
  ipcMain.handle("quit-and-install", () => {
    appUpdater == null ? void 0 : appUpdater.quitAndInstall();
  });
